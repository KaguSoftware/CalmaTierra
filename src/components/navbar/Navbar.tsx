...
export default function Navbar() {
    ...
    return (
        <main>
            <nav className="w-full h-20 z-999 flex items-center gap-8 md:px-10 px-4 bg-white/80 backdrop-blur-lg sticky ">
                ...
                <button
                    onClick={toggleMenu}
                    className={`md:hidden ml-auto duration-200 relative text-green-900 ${
