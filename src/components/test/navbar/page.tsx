...
export default function Navbar() {
    return (
        <nav className="w-full h-20 flex items-center gap-8 px-10 z-100 bg-white sticky top-0">
            ...
            <div className=" md:flex hidden items-center ml-auto gap-8">
                ...
                <Link href={"/ContactUs"}>
                    <button className="px-4 hover:bg-green-800 py-2 rounded-md bg-green-900">
                        {" "}
                        Contact Us{" "}
                    </button>
                </Link>
